...
public class ProductHomePageSubCategoryAdapter extends RecyclerView.Adapter<ProductHomePageSubCategoryAdapter.ProductHomePageSubCategoryViewHolder>{

    Context context;
    ArrayList<ProductSubCategoryModel> list;
    LayoutInflater inflater;

    public ProductHomePageSubCategoryAdapter(Context context, ArrayList<ProductSubCategoryModel> list) {
    ...
    @NonNull
    @Override
    public ProductHomePageSubCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.product_home_page_category_list_item, parent, false);
        return new ProductHomePageSubCategoryAdapter.ProductHomePageSubCategoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductHomePageSubCategoryViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                productRequestModel.ProductSubCategoryIds = brandId;
    ...
    class ProductHomePageSubCategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductHomePageSubCategoryViewHolder(View itemView) {
            super(itemView);

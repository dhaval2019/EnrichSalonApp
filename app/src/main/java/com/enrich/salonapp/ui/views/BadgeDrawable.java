...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.dark_gold));
        mBadgePaint.setAntiAlias(true);
        mBadgePaint.setStyle(Paint.Style.FILL);

        mBadgePaint1 = new Paint();
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.dark_gold));
    ...
    public void draw(Canvas canvas) {
        ...
        float radius = (float) (((Math.max(width, height) / 2.5)) / 2.5);
...
//	        	canvas.drawRoundRect(radius, radius, radius, radius, 10, 10, mBadgePaint);
    ...
    public void removeBadge(Context context) {
        mBadgePaint.setColor(Color.parseColor("#00ffffff"));
        mBadgePaint1.setColor(Color.parseColor("#00ffffff"));

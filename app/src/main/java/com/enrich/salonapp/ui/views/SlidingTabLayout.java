...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        mTabStrip.setBackgroundResource(R.color.tab_background);
    }

    private CustomTextView createDefaultTabView(Context context) {
...
//        textView.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        if (isAppointment) {
            ...
            textView.setLayoutParams(new LinearLayout.LayoutParams(width / 2, ViewGroup.LayoutParams.WRAP_CONTENT));
        }
        ...
        int sidePadding = (int) (getResources().getDimension(R.dimen.medium_margin) * getResources().getDisplayMetrics().density);
        int topPadding = (int) (getResources().getDimension(R.dimen.small_med_margin) * getResources().getDisplayMetrics().density);
    ...
    private void resetColor(int selected) {
        for (int i = 0; i < mTabStrip.getChildCount(); i++)
            ((TextView) mTabStrip.getChildAt(i)).setTextColor(getResources().getColor(i == selected ? R.color.red : R.color.grey));
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            resetColor(position);
//            Log.e("ZZZZZ", selectedTitle.getClass().getSimpleName());

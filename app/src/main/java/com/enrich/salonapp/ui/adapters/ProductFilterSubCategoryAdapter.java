...
public class ProductFilterSubCategoryAdapter extends RecyclerView.Adapter<ProductFilterSubCategoryAdapter.SubCategoryViewHolder> {

    Activity activity;
    ArrayList<ProductSubCategoryModel> list = new ArrayList<>();
    LayoutInflater inflater;

    public ProductFilterSubCategoryAdapter(Activity activity, ArrayList<ProductSubCategoryModel> list) {
        ...
        holder.subCategoryCheckbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isInSubCategoryId(model.Id)) {
                    ...
                    ((ProductFilterActivity) activity).getProductRequestModel().ProductSubCategoryIds.remove(Integer.valueOf(model.Id));
                }

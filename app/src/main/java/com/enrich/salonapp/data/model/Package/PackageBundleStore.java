...
public class PackageBundleStore implements Parcelable {
    ...
    protected PackageBundleStore(Parcel in) {
    ...
    public static final Creator<PackageBundleStore> CREATOR = new Creator<PackageBundleStore>() {
        @Override
        public PackageBundleStore createFromParcel(Parcel in) {
            return new PackageBundleStore(in);
        }

        @Override
        public PackageBundleStore[] newArray(int size) {
            return new PackageBundleStore[size];
        }
    };
}

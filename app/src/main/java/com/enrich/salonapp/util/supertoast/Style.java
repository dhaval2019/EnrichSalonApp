...
import com.enrich.salonapp.util.supertoast.utils.PaletteUtils;
...
public class Style implements Parcelable {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TYPE_STANDARD, TYPE_BUTTON, TYPE_PROGRESS_CIRCLE, TYPE_PROGRESS_BAR, TYPE_IMAGE_AND_BUTTON})
    ...
    public static final int TYPE_IMAGE_AND_BUTTON = 5;
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeString(messageImageURL);

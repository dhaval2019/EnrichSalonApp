package com.enrich.salonapp.util.supertoast;
...
import com.enrich.salonapp.util.supertoast.utils.BackgroundUtils;
import com.enrich.salonapp.util.supertoast.utils.ListenerUtils;
...
public class SuperActivityToast extends SuperToast {
     ...
     * SuperActivityToast.OnButtonClickListener)
     */
    ...
    private SuperActivityToast.OnButtonClickListener mOnButtonClickListener;
    ...
    public SuperActivityToast(@NonNull Context context, @NonNull Style style,
        ...
        this.mViewGroup = ((Activity) context).findViewById(viewGroupId);
    ...
    protected View onCreateView(@NonNull Context context, LayoutInflater layoutInflater,
        ...
        switch (type) {
            ...
            case Style.TYPE_IMAGE_AND_BUTTON:
                this.mView = layoutInflater.inflate(R.layout.supertoast_image_and_button, (ViewGroup)
                        ((Activity) context)
                                .findViewById(android.R.id.content), false);
                break;
    ...
    /**
     * Sets the {@link SuperToast.OnDismissListener}
     ...
     * duration set by the
     * {@link SuperToast#setDuration(int)}
    ...
    /**
     * Sets the
     * {@link SuperActivityToast.OnButtonClickListener}
    ...
    public SuperActivityToast setOnButtonClickListener(@NonNull String tag, Parcelable token,
                                                       @NonNull SuperActivityToast.OnButtonClickListener onButtonClickListener) {
     ...
     */
    public SuperActivityToast.OnButtonClickListener getOnButtonClickListener() {
    ...
    protected void onPrepareShow() {
        ...
        switch (this.mStyle.type) {
            ...
            case Style.TYPE_BUTTON:
                ...
                final Button button = this.mView.findViewById(R.id.button);
            ...
            case Style.TYPE_IMAGE_AND_BUTTON:
                if (this.mStyle.frame != Style.FRAME_LOLLIPOP) {
                    this.mStyle.width = FrameLayout.LayoutParams.MATCH_PARENT;
                    this.mStyle.xOffset = BackgroundUtils.convertToDIP(0);
                    this.mStyle.yOffset = BackgroundUtils.convertToDIP(0);
                }
                ...
                // Set up the Button attributes
                final ImageButton buttonType2 = this.mView.findViewById(R.id.button);
                buttonType2.setBackgroundResource(BackgroundUtils
                        .getButtonBackgroundResource(this.mStyle.frame));
                ...
                if (this.mStyle.frame != Style.FRAME_LOLLIPOP) {
                    ...
                    // Set an icon resource if desired
                    if (this.mStyle.buttonIconResource > 0) {
                        buttonType2.setImageDrawable(ResourcesCompat
                                .getDrawable(mContext.getResources(),
                                        this.mStyle.buttonIconResource,
                                        mContext.getTheme()));
                    }
     ...
     * {@link SuperToast.OnDismissListener}
     * or
     * {@link SuperActivityToast.OnButtonClickListener}
     * in your SuperActivityToast, use
     * {@link ListenerUtils#newInstance()}
     * along with
     * {@link ListenerUtils
    ...
    public static void onRestoreState(Context context, Bundle bundle,
        ...
        for (Style style : styleList) {
            if (!style.isSuperActivityToast) new SuperToast(context, style).show();
                ...
                final SuperActivityToast.OnButtonClickListener onButtonClickListener = listenerUtils
